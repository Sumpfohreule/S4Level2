...
# AL Freiland
al_freiland_adlm_uri <- new("URI", "Altensteig/Freiland/ADLM")
...
# AL Buche
al_buche_adlm_uri <- new("URI", file.path(plot_name, "Buche", "ADLM"))
...
# AL Fichte
al_fichte_adlm_uri <- new("URI", "Altensteig/Fichte/ADLM")
level2 <- createAndAddLogger(level2,
    logger_type = "ADLM",
